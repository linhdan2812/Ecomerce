...
@section('content')
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="checkout-form">
                            ...
                            <form action="{{ url('thanh-toan') }}" id="create_form" method="POST">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="hidden" value="Thanh toan hoa don ban hang"
                                        id="order_desc" name="order_desc">
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                ...
                                <div class="myAddress">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class=" form-control" name="txt_billing_fullname" value="{{ $user->name }}" disabled id="txt_billing_fullname">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Email</label>
                                            <input type="text" class="form-control" value="{{ $user->email }}" disabled id="txt_billing_email" name="txt_billing_email" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAddress">Số điện thoại</label>
                                        <input type="text" class="form-control" value="{{ $user->phone }}" id="txt_billing_mobile" name="txt_billing_mobile" disabled>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="txt_bill_state" name="txt_bill_state" type="hidden"
                                        value="" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_bill_country" name="txt_bill_country"
                                        type="hidden" value="VN" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_fullname" name="txt_ship_fullname"
                                        type="hidden" value="Nguyễn Thế Vinh" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_mobile" name="txt_ship_mobile"
                                        type="hidden" value="0123456789" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_addr1" name="txt_ship_addr1" type="hidden"
                                        value="Phòng 315, Công ty VNPAY, Tòa nhà TĐL, 22 Láng Hạ, Đống Đa, Hà Nội" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_postalcode" name="txt_ship_postalcode"
                                        type="hidden" value="1000000" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_city" name="txt_ship_city" type="hidden"
                                        value="Hà Nội" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_state" name="txt_ship_state" type="hidden"
                                        value="" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_ship_country" name="txt_ship_country"
                                        type="hidden" value="VN" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_inv_customer" name="txt_inv_customer"
                                        type="hidden" value="Lê Văn Phổ" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control" id="txt_inv_company" name="txt_inv_company"
                                        type="hidden" value="Công ty Cổ phần giải pháp Thanh toán Việt Nam" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="txt_inv_taxcode" name="txt_inv_taxcode"
                                        type="hidden" value="0102182292" />
                                </div>
                                <div class="form-group">
                                ...
                                <div>
                                    <button type="submit" name="redirect" id="redirect" class="btn btn-dark">Thanh
                                        toán</button>
                                </div>
                    ...
                    <div class="col-6">
                                    ...
                                    <table style="width:100%">
                                        <tr data-id="{{ $id }}">
                                            ...
                                            <td style="width:20;text-align: end;" data-th="Price" class="product-price">
                                                <span class="price">{{ number_format($details['price']) }}</span>
                                            </td>
                                            <td style="width:10%;text-align: end;" data-th="Quantity">
                                                X {{ $details['quantity'] }}
                                            </td>
                                            <td style="width:20%;text-align: end;" data-th="Subtotal"
                                                class="total-price">
                                                <span class="price">
                                                    {{ number_format($details['price'] * $details['quantity']) }} </span>VNĐ
                                            </td>
                                        </tr>
                                    </table>
                                    <br>
                        ...
                        <li>Cillum dolore tortor nisl X 01 <span>$25.00</span></li>
                            ...
                            <h4>Tổng cộng
                                <span>{{ number_format($newTotal) ? number_format($newTotal) : number_format($total) }}
                                    VNĐ</span></h4>
    ...
    <script>
        ...
        $('.otherAddress').hide();
        $(document).on('change', '#autoSizingCheck', function() {
            if(this.checked) {
                $('.myAddress').hide();
                $('.otherAddress').show();
            }
