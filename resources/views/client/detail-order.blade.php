    ...
    <div class="col-lg-9">
        <div class="main-content">
            <div class="wrap-process-order">
                ...
                <div class="top">
                    ...
                    @if ($detailorder->status_order == 'pending')
                        <div class="right">
                            <a href="{{ route('cancel.order', ['id' => $detailorder->id]) }}"
                                onclick="return confirm('Bạn có chắc muốn hủy đơn hàng này không?');"
                                class="btn-second gray">Hủy đơn hàng</a>
                        </div>
                    @endif
                    @if ($detailorder->status_order == 'success')
                        <div class="right">
                            <a href="{{ route('error.order', ['id' => $detailorder->id]) }}" class="btn-second warning">Báo
                                lỗi</a>
                            <a href="{{ route('order.finished', ['id' => $detailorder->id]) }}"
                                class="btn-second success">Hoàn thành</a>
                        </div>
                    @endif
                </div>
                ...
                @if ($detailorder->status_order == 'cancel')
                <div class="order-process">
                    <div class="item active">
                        <div class="icon"><i class="fal fa-check-circle"></i></div>
                        <p>Đã hủy đơn hàng</p>
                    </div>
                </div>
                @elseif(
                    $detailorder->status_order == 'pending' ||
                        $detailorder->status_order == 'shipping' ||
                        $detailorder->status_order == 'success' ||
                        $detailorder->status_order == 'finished')
                    <div class="order-process">
                        @if ($detailorder->status_order == 'pending')
                            <div class="item active">
                                <div class="icon"><i class="fal fa-check-circle"></i></div>
                        ...
                        <tr>
                            <td>
                                <div class="item-cart v2">
                                    <a class="img"><img src="{{ asset('storage/' . $key['image']) }}" width="70"
                                            alt=""></a>
                                    <div class="ct">
                                        <h3 class="title">
            ...
            <div class="order-address-person">
                ...
                <ul>
                    <li><span>Họ và
                            tên:</span>{{ $detailorder->vnp_Bill_FirstName . ' ' . $detailorder->vnp_Bill_LastName ?? null }}
                    </li>
                ...
                <div class="back-order">
                    <a href="{{ route('orders') }}" title=""><i class="far fa-long-arrow-alt-left"></i> <span>Trở
                            về đơn hàng</span></a>
                </div>
            </div>
        </div>
